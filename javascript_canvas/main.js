...
$(document).ready(function()
   {
    ...
    imgMain=new Image();
    imgMain.src="javascript_canvas/images/spritesheet.png";
    currentImgMainX=0;
    currentImgMainY=0;
    ...
    imgMountain.src="javascript_canvas/images/material.png";
    imgEnemy=new Image();
    imgEnemy.src="javascript_canvas/images/enemy.png";
